...
Le fichier "requirements" recense l'ensemble des packages Python externes à installer afin de pouvoir lancer le Notebook. La première cellule du Notebook permet de les installer directement. 
